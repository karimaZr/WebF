                    ...
                    <div className='flex flex-col items-center w-full'>
                        ...
                        <div className='flex py-5  bg-white rounded-xl shadow-md w-4/5  justify-center items-center'>
                            <span className='flex w-2/5 justify-center'>
                                <img src={student.photo === null ? 'https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava3.webp': `data:image/png;base64, ${student.photo}`} className='w-36 h-36 rounded-full mx-2 border-4 border-gray-300' />
                            </span>
